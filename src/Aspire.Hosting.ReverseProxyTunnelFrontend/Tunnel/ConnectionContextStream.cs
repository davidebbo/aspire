...
internal sealed class ConnectionContextStream : Stream, IValueTaskSource<object?>
{
    ...
    {
        await _connectionContext.Transport.Output.WriteAsync(buffer, cancellationToken).ConfigureAwait(false);
    }
